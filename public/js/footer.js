...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Step 1: Create a new EMPTY footer element
        ...
        <div class="footer-links-container">
            ...
            <div class="footer-column">
                ...
                <ul>
                    ...
                    <li><a href="all_playlists.html">All Playlists</a></li>
                </ul>
            </div>
            <div class="footer-column">
                <h4>Useful Links</h4>
            ...
            <div class="social-links-column">
                ...
                <a href="#" title="GitHub" class="social-icon">
    ...
    `;
    // Step 3: Assign HTML content to footerElement
    footerElement.innerHTML = footerHTML;

    // Step 4: Replace placeholder with completed footer
